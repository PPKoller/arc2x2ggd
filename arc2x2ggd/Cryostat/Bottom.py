...
class BottomBuilder(gegede.builder.Builder):
    ...
    def configure( self, dz=None, rmax=None, rmin=None,
                    shifts=None, material=None, **kwds ):
    ...
    def construct( self, geom ):
        ...
        # place legs
        pla = self.shifts[0]*np.cos(np.pi/4.)

        leg_pos1 = geom.structure.Position(self.name+leg_lv.name+ '_pos1', pla, pla, self.shifts[1])     
        ...
        leg_pos2 = geom.structure.Position(self.name+leg_lv.name+ '_pos2', -1*pla, pla, self.shifts[1])     
        ...
        leg_pos3 = geom.structure.Position(self.name+leg_lv.name+ '_pos3', -1*pla, -1*pla, self.shifts[1])     
        ...
        leg_pos4 = geom.structure.Position(self.name+leg_lv.name+ '_pos4', pla, -1*pla, self.shifts[1])     
